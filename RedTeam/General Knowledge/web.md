...
## Content table
  ...
  * [Cross-site request forgery (CSRF)](#cross-site-request-forgery-%28csrf%29)
  * [Clickjacking](#clickjacking)
  * [DOM-based vulnerabilities](#dom-based-vulnerabilities)
  * [Cross-origin resource sharing (CORS)](#cross-origin-resource-sharing-%28cors%29)
  * [XML external entity (XXE) injection](#xml-external-entity-%28xxe%29-injection)
  * [Server-side request forgery (SSRF)](#server-side-request-forgery-%28ssrf%29)
