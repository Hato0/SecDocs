...
Additional options:  
 ...
 For a more specific enumeration we should use `smbclient` or `smbmap`.
...
Flags:
 ...
 Here is an example to enum users : (previously associated domain with ip on /etc/hosts file)
 ```shell
